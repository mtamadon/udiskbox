...
#define DS1302_CLK_H() do{HAL_GPIO_WritePin(GPIOE, GPIO_PIN_4, GPIO_PIN_SET);}while(0)
#define DS1302_CLK_L() do{HAL_GPIO_WritePin(GPIOE, GPIO_PIN_4, GPIO_PIN_RESET);}while(0)

#define DS1302_RST_H() do{HAL_GPIO_WritePin(GPIOE, GPIO_PIN_6, GPIO_PIN_SET);}while(0)
#define DS1302_RST_L() do{HAL_GPIO_WritePin(GPIOE, GPIO_PIN_6, GPIO_PIN_RESET);}while(0)

#define DS1302_OUT_H() do{HAL_GPIO_WritePin(GPIOE, GPIO_PIN_5, GPIO_PIN_SET);}while(0)
#define DS1302_OUT_L() do{HAL_GPIO_WritePin(GPIOE, GPIO_PIN_5, GPIO_PIN_RESET);}while(0)

#define DS1302_IN_X  HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_5)
